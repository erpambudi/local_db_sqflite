...
class DatabaseHelper {
  ...
  Future<void> insertNote(Note note) async {
    ...
    ///agar model note dapat dimasukan ke dalam tabel maka diubah menjadi map
  ...
  Future<List<Note>> getNotes() async {
    ...
    ///results di maping ke model Note
    ///pada proses maping data res(satuan) diubah dulu menggunakan .fromMap()
    ///lalu dijadikan sebuah list dengan toList()
